...
from offlinerlkit.policy import SQLPolicy


def get_args():
    parser = argparse.ArgumentParser()
    parser.add_argument("--algo-name", type=str, default="sql")
    ...
    parser.add_argument('--reward_norm', type=bool, default=True)
...
def train(args=get_args()):
    ...
    if 'antmaze' in args.task:
        dataset["rewards"] -= 1.0
    if ("halfcheetah" in args.task or "walker2d" in args.task or "hopper" in args.task) and args.reward_norm:
