...
from offlinerlkit.modules import EnsembleCritic
...
from offlinerlkit.policy import WBCEnsemblePolicy


def get_args():
    parser = argparse.ArgumentParser()
    parser.add_argument("--algo-name", type=str, default="wbc-ensemle")
...
def train(args=get_args()):
    ...
    critic_v_backbone = MLP(input_dim=np.prod(args.obs_shape), hidden_dims=[256, 256])
    ...
    critics = EnsembleCritic(np.prod(args.obs_shape), args.action_dim, args.hidden_dims, num_ensemble=args.num_critics,device=args.device)
